#!/usr/bin/env perl
#===============================================================================
# Submitter for __6_SortAndCompressPerChrom.pl
# One SLURM job per (chromosome x k) — sorts, bgzips, and tabix-indexes the
# per-chromosome BED of conversion-compatible positions.
#===============================================================================
use strict;
use warnings;
...
foreach my $k (@KS) {
    foreach my $chr (@CHROMS) {
        my $base = "$JOBDIR/sortcompress.k${k}.chr${chr}";
...
perl $CODE_DIR/__6_SortAndCompressPerChrom.pl \\
    --CHROM=$chr --REP_LEN=$k \\
